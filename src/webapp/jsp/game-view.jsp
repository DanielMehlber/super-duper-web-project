...
<main id="main" onclick="hideNav()">
    ...
    <div class="game-background-container">
        <img class="game-background-image" src="games/images?id=${gamePageViewBean.game.id}&type=background">
    </div>
    <div class="game-main-container">
        <div class="game-information-container">
            <div class="game-cover-container">
                <img class="game-cover-image" src="games/images?id=${gamePageViewBean.game.id}&type=profile" alt=""/>
            </div>
        ...
        <div class="game-teams-container">
            ...
            <c:forEach items="${requestScope.gamePageViewBean.teams}" var="team">
                <a class="team-container" href="teams/team?id=${team.id}">
                    <img class="team-background" src="teams/images?type=background&id=${team.id}">
