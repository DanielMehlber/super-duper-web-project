...
<main id="main" onclick="hideNav()">
    ...
    <div class="game-background-container">
        <img alt="game background image" class="game-background-image" src="${pageContext.request.contextPath}/games/images?id=${gamePageViewBean.game.id}&type=background">
    </div>
    <div class="game-main-container">
        <div class="game-information-container">
            <div class="game-cover-container">
                <img class="game-cover-image" src="${pageContext.request.contextPath}/games/images?id=${gamePageViewBean.game.id}&type=profile" alt="game cover image"/>
            </div>
